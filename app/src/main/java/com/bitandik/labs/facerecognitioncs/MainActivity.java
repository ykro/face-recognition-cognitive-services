package com.bitandik.labs.facerecognitioncs;
...
import com.bitandik.labs.facerecognitioncs.utils.CognitiveServicesUtils;
import com.bitandik.labs.facerecognitioncs.utils.PermissionUtils;
...
import static com.bitandik.labs.facerecognitioncs.utils.PermissionUtils.CAMERA_PERMISSIONS;
import static com.bitandik.labs.facerecognitioncs.utils.PermissionUtils.GALLERY_PERMISSIONS;
...
public class MainActivity extends AppCompatActivity {
  ...
  @BindString(R.string.cognitive_services_vision_key) String APIKey;

  private String currentPhotoPath;
  private CognitiveServicesUtils cognitiveServicesUtils;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    cognitiveServicesUtils = CognitiveServicesUtils.init(APIKey);
  ...
  private void analyzeImage(final Bitmap bitmap) throws IOException {
    new AsyncTask<Void, Void, String>() {
      ...
      protected String doInBackground(Void... params) {
        ...
        try {
          response = cognitiveServicesUtils.getAnnotations(bitmap);
        } catch (IOException e) {
          e.printStackTrace();
      ...
      protected void onPostExecute(String result) {
        txtMainLabels.setText(result);
        drawRectanglesAroundFaces(bitmap, cognitiveServicesUtils.getFacesRectangles());
  ...
  public void drawRectanglesAroundFaces(Bitmap bitmap, ArrayList<RectF> rectangles) {
    if (rectangles == null || bitmap == null)
      return;
